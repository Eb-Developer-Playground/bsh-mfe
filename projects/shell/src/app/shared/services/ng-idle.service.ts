...
export class NgIdleService implements OnDestroy {
  ...
  public static runSecondTimer: boolean; // @ts-ignore
  public USER_IDLE_TIMER_VALUE_IN_MIN: number; // @ts-ignore
  public FINAL_LEVEL_TIMER_VALUE_IN_MIN: number;
  public userIdlenessChecker: BehaviorSubject<string>;
  public secondLevelUserIdleChecker: BehaviorSubject<string>; // @ts-ignore
  private sessionForIdle: Observable<number>; // @ts-ignore
  ...
  get lastAction(): number {
    return parseInt(<string>localStorage.getItem(STORE_KEY), 10);
  }
