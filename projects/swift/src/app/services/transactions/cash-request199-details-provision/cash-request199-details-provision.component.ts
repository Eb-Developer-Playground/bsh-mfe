...
@Component({
  ...
  selector: 'app-cash-request199-details-provision',
  templateUrl: './cash-request199-details-provision.component.html',
  styleUrls: ['./cash-request199-details-provision.component.scss'],
})
export class CashRequest199DetailsProvisionComponent implements OnInit, AfterViewInit, OnDestroy {
  fieldsForm!: UntypedFormGroup;
  actionForm!: UntypedFormGroup;
  formFields: any[] = FIELDS[PROCESSES.PROVISION_OF_DETAILS];
