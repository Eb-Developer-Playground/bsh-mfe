...
export class AccountStatementService {
 ...
 invokeActions(actionType: 'GetAccountStatementPageCount' | 'GetAccountStatementCharge' | 'GetAccountBalance' | 'GeneratePdf',   ticket: number, version: 'V3' | 'V2' = 'V3') {
  ...
  public submitIndividual(data: AccountStatementV2): Observable<any> {
    ...
    //return this.api.post<any>(`/v1/backoffice/AccountStatement/submit`, data);
  }

  public verifyBio(data: Bio,taskId:string, customerNotPresent = false): Observable<any> {
    //`/v1/backoffice/AccountStatement/${taskId}/bio-verify`
  ...
  public getStatementPageCount(ticketId: string): Observable<StatementPageCountResponse> {
    return this.api.post<any>('/v1/backoffice/AccountStatement/StatementPagecount/' + ticketId, null);
  }

  public calculateCharge(data: CalculateChargePayload): Observable<CalculateChargeResponse> {
    return this.api.post<any>('/v1/backoffice/AccountStatement/CalculateCharge', data);
  }
