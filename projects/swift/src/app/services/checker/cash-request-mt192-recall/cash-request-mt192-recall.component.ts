...
@Component({
  ...
  selector: 'app-cash-request-mt192-recall',
  templateUrl: './cash-request-mt192-recall.component.html',
  styleUrls: ['./cash-request-mt192-recall.component.scss'],
})
export class CashRequest192RecallComponent implements OnInit {
  data!: any;
  documents!: any[];
  fields = CHECKER_FIELDS[PROCESSES.RECALL];
