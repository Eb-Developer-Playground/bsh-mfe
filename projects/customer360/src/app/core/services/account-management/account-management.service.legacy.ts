...
export class AccountManagementService {
  ...
  getCustomerCifData = () => {
    let cifData: any = localStorage.getItem('customerCifData');
  ...
  // getCustomerAccountsTableData = () => this.customerAccountsTableData;
  ...
  getDepositAccountsWhere = (filterFunction: any) => {
    if (!localStorage.getItem('depositAccounts')) return;
