...
@Component({
  ...
  selector: 'app-cash-request199-confirmation103',
  templateUrl: './cash-request199-confirmation103.component.html',
  styleUrls: ['./cash-request199-confirmation103.component.scss'],
})
export class CashRequest199Confirmation103Component implements OnInit, AfterViewInit, OnDestroy {
  fieldsForm!: UntypedFormGroup;
  actionForm!: UntypedFormGroup;
  formFields: any[] = FIELDS[PROCESSES.CONFIRM_OF_MT103];
