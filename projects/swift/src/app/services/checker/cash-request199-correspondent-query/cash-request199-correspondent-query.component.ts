...
import { CHECKER_FIELDS, PROCESSES, REQUIRED_DOCS } from '../../../../shared/static';
...
export class CashRequest199CorrespondentQueryComponent implements OnInit {
  fields: any[] = CHECKER_FIELDS[PROCESSES.CORRESPONDENT_QUERY];
  data!: any;
  documents!: any[];
